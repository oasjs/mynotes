          ...
          switch (state.exception.runtimeType) {
            case UserNotFoundAuthException:
              await showErrorDialog(
                  context, 'We could not find a user with the provided email.');
              break;
            case InvalidEmailAuthException:
              await showErrorDialog(
                  context, 'The provided email is not valid.');
              break;
          }
        }
      },
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: Column(
            children: [
              const Text(
                  "If you have forgotten your password, enter your account email address and we'll send you a password reset email"),
              TextField(
